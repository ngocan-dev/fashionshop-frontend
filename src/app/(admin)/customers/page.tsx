...
import { useAdminCustomerAccountsQuery, useDeleteAdminAccountByEmailMutation, useDeleteAdminUserMutation } from '@/features/admin/hooks';
...
export default function AdminCustomersPage() {
  ...
  if (accountsQuery.isError) return <EmptyState title="Customers unavailable" description="Unable to load customer accounts." actionLabel="Retry" actionHref="/customers" />;
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">View and manage customer accounts.</p>
      </div>
      <Card>
        <CardHeader><h2 className="text-lg font-semibold">Delete by email</h2></CardHeader>
        <CardContent>
          <form
      ...
      <Card>
        <CardHeader><h2 className="text-lg font-semibold">All customers</h2></CardHeader>
        <CardContent>
          <DataTable
